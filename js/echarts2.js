...
function linkList(opt) {
  ...
  each$6(datas, function (data) {
    each$6(mainData.TRANSFERABLE_METHODS, function (methodName) {
  ...
  each$6(mainData.CHANGABLE_METHODS, function (methodName) {
...
function cloneShallowInjection(opt, res) {
  ...
  each$6(res[DATAS], function (data, dataType) {
...
function linkAll(mainData, datas, opt) {
  mainData[DATAS] = {};
  each$6(datas, function (data, dataType) {
