...
(function($){
	...
	_view = {
		...
		editNode: function(setting, node) {
			...
			view.cancelCurEditNode(setting);
			view.selectNode(setting, node, false);
			$$(node, consts.id.SPAN, setting).html("<input type=text class='rename' id='" + node.tId + consts.id.INPUT + "' treeNode" + consts.id.INPUT + " ><span class='button ok_btn' id='" + node.tId + consts.id.BTNT + "'></span><span class='button no_btn' id='" + node.tId + consts.id.BTNC + "'></span>");
			var inputObj = $$(node, consts.id.INPUT, setting);
			var btntObj =  $$(node, consts.id.BTNT, setting);
			var btncObj =  $$(node, consts.id.BTNC, setting);
			...
			btntObj.bind('blur', function(event) {
				if (!view.editNodeBlur) {
					view.cancelCurEditNode(setting);
				}
			})
			btncObj.bind('blur', function(event) {
				return false;
			})
